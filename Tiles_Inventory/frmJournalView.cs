...
{
    public partial class frmJournalView : BaseForm
    {
        public frmJournalView()
        {
            InitializeComponent();
        }
        ...
        private void LoadJournalInformation(string fromDate, string toDate)
        {
           ...
           // lstJournal = lstJournal.Where(j => j.JournalType == (int)MTBFEnums.JournalType.Inventory).ToList();
